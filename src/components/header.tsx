...
const Header = () => {
  return (
    <header className='flex min-h-24 flex-col items-center gap-2 border-b border-neutral-300/90 bg-background p-3 dark:border-neutral-700/65 sm:flex-row sm:justify-between'>
